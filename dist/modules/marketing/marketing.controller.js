...
], WaitlistDto.prototype, "email", void 0);
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Join the waitlist (public)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Email added to waitlist.' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email already registered.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [WaitlistDto]),
    __metadata("design:returntype", Promise)
], MarketingController.prototype, "joinWaitlist", null);
