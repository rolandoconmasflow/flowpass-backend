...
export declare class MembershipsController {
    ...
    getMembership(membershipId: string): Promise<({
        customer: {
    ...
    joinMerchant(req: any, dto: JoinMerchantDto): Promise<(import("@prisma/client/runtime/library").GetResult<{
        id: string;
        customerId: string;
        merchantId: string;
        loyaltyProgramId: string | null;
    ...
    getCustomerCard(_membershipId: string): Promise<{
        message: string;
    }>;
    getCustomerCards(req: any): Promise<{
        message: string;
        cards: never[];
    } | {
        message: string;
