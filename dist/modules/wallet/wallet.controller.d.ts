...
export declare class WalletController {
    ...
    generatePass(req: any, generatePassDto: GeneratePassDto): Promise<{
    ...
    revokePass(id: string): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        membershipId: string;
        provider: import("@prisma/client").WalletProvider;
        externalId: string | null;
