...
export declare class LevelsController {
    ...
    create(dto: CreateLevelDto): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        merchantId: string;
        name: string;
        minPoints: number;
    ...
    update(id: string, dto: UpdateLevelDto): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        merchantId: string;
        name: string;
        minPoints: number;
    ...
    enableLevels(merchantId: string): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        name: string;
        slug: string;
    ...
    disableLevels(merchantId: string): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        name: string;
        slug: string;
        description: string | null;
    ...
    getLevelsStatus(merchantId: string): Promise<{
        levelsEnabled: boolean;
    }>;
}
