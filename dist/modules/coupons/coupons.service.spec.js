...
describe('CouponsService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [coupons_service_1.CouponsService, { provide: prisma_service_1.PrismaService, useValue: mockPrisma }],
        }).compile();
        couponsService = module.get(coupons_service_1.CouponsService);
        jest.clearAllMocks();
    });
    describe('getCouponByCode', () => {
        it('should return coupon details for valid code', async () => {
            const mockCoupon = {
                id: 'coupon-1',
                code: 'FLOW-ABC123',
                status: client_1.CouponStatus.CLAIMED,
                claimedAt: new Date(),
        ...
        it('should throw NotFoundException for invalid code', async () => {
            ...
            await expect(couponsService.getCouponByCode('INVALID')).rejects.toThrow(common_1.NotFoundException);
        });
    });
...
//# sourceMappingURL=coupons.service.spec.js.map