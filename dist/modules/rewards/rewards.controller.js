...
let RewardsController = class RewardsController {
    ...
    async redeem(id, customerId) {
        return this.rewardsService.redeem(id, customerId);
    }
    async history(membershipId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [reward_dto_1.CreateRewardDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RewardsController.prototype, "findByMerchant", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('catalog/:customerId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get rewards catalog for customer' }),
    __param(0, (0, common_1.Param)('customerId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RewardsController.prototype, "catalog", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, reward_dto_1.UpdateRewardDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)(':id/redeem/:customerId'),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('history/:membershipId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get redemption history' }),
