...
export declare class RewardsService {
    ...
    create(data: CreateRewardDto): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        merchantId: string;
    ...
    update(id: string, data: UpdateRewardDto): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        merchantId: string;
        loyaltyProgramId: string | null;
        title: string;
    ...
    getCustomerCatalog(customerId: string): Promise<{
        canRedeem: boolean;
        userPoints: number;
        userVisits: number;
        merchant: {
    ...
    redeem(rewardId: string, customerId: string): Promise<import("@prisma/client/runtime/library").GetResult<{
        id: string;
        rewardId: string;
        membershipId: string;
        customerId: string;
    ...
    getRedemptionHistory(membershipId: string): Promise<({
