...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update own profile (name)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Reset link sent if email exists.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
