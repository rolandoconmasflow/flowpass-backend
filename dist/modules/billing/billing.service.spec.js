...
describe('BillingService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                { provide: stripe_provider_1.STRIPE_CLIENT, useValue: mockStripe },
            ],
        }).compile();
    ...
    describe('handleWebhook', () => {
        ...
        it('rechaza firma inválida', async () => {
            ...
            await expect(service.handleWebhook('bad', Buffer.from('{}'))).rejects.toThrow(common_1.BadRequestException);
        });
    });
});
